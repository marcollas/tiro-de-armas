...
def test_detector():
    ...
    print(
        f"Resultado: {'✓ TIRO DETECTADO' if result_gunshot['is_gunshot'] else '✗ NÃO DETECTADO'}"
    )
    ...
    print(
        f"Resultado: {'✗ FALSO POSITIVO' if result_ambient['is_gunshot'] else '✓ CORRETAMENTE REJEITADO'}"
    )
